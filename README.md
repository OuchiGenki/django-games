...
Django で作成したミニゲーム集サイト（ポートフォリオ）です。  
学習・スキル証明・作品公開を目的としており、今後も継続的にゲームを追加していく予定です。
ページの下部に、簡潔ではありますが開発時のポイントをまとめております。
...
- **Gomoku（五目並べ） ← New!**
  ...
  <img width="1440" height="811" alt="image" src="https://github.com/user-attachments/assets/1e63b136-0439-4120-ac5d-913ef5238b6d" />
